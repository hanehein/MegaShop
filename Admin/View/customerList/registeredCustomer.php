...
<body class="overflow-x-hidden ">
    ...
    <div class="min-h-screen flex   bg-black text-gray-800 relative ">
        ...
        <div class="w-full flex flex-col  items-end justify-center bg-gray-200 space-y-5 font-['Poppins'] ">
            ...
            <div class="w-auto flex items-center justify-center bg-[#00336659] font-['Poppins'] rounded-md shadow-sm shadow-black m-20">
            ...
            <!-- pagination -->
            <div class="w-auto flex items-center justify-center h-10 mb-5 m-20">
