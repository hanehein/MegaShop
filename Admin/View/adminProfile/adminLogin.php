...
<body class="overflow-x-hidden bg-white">
    ...
    <div class="w-auto h-screen container flex mx-auto justify-center items-center ">
        ...
        <div class="md:w-[26rem] w-[18rem] h-[32rem] container mx-auto flex-col items-center justify-center bg-[#CCCCCC]  rounded-bl-3xl rounded-tr-3xl shadow-md shadow-black">
            <!-- logo section -->
            <div class="md:w-[26rem] w-[18rem]  h-48 flex flex-col items-center justify-center  bg-[#003366] rounded-bl-3xl rounded-tr-3xl space-y-14">
            ...
            <div class="mt-10 container md:w-[25rem] mx-auto font-['Poppins']">
                ...
                <!-- email -->
                <form action="">
                    <div class="md:w-[18rem] w-[15rem] bg-[#003366] border border-white rounded-bl-3xl rounded-tr-3xl mx-auto mt-4 flex py-1.5 px-4 space-x-3 justify-center items-center">
                    ...
                    <!-- password -->
                    <div class="md:w-[18rem] w-[15rem] bg-[#003366] border border-white  mx-auto mt-8 flex py-1.5 px-4 space-x-3 justify-center items-center rounded-bl-3xl rounded-tr-3xl">
                    ...
                    <!-- login -->
                    <button type="submit" class="w-32 bg-[#003366] mx-auto mt-8 flex py-2 justify-center items-center text-white active:bg-gray-200 active:text-[#003366] text-sm font-semibold rounded-bl-3xl rounded-tr-3xl">
                        Log In
                    </button>
                </form>
            </div>
