...
<section class="bg-gray-50 min-h-screen flex items-center justify-center">
        <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5">
            ...
            <div class="md:w-1/2 relative flex flex-col items-center justify-center">
                <h6 class="mt-14 text-center font-extrabold text-[18px] text-[#2C7607]">New Password</h6>
                <span class=" text-center font-medium text-[12px] text-[#2C7607] mb-5">Please enter your new password</span>
                <form action="" class="flex flex-col gap-4 justify-center items-center">
                    <div class="relative">
                        <input class="p-2 my-2 rounded-xl border border-[#2C7607] shadow-md w-[300px] h-[40px]"
