        ...
        <div class=" bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5">
            ...
            <div class="md:w-1/2 relative flex flex-col items-center justify-center">
                ...
                <div class="md:px-8 flex-col justify-center items-center">
                    <h6 class="mt-14 text-center font-extrabold text-[18px] text-[#2C7607]">Verify E-mail Address</h6>
                    <span class=" text-center font-medium text-[12px] text-[#2C7607]">Enter confirmation code that sent
                        to associated with your account.</span>

                </div>
                <div class="flex justify-between m-5">
                    <div class="w-[50px] h-[50px] bg-green-200 flex items-center justify-center border border-[#2C7607] shadow-md"
                ...
                <button
                    class="my-4 bg-[#2C7607] rounded-xl text-white text-base py-4 px-12 hover:scale-105 duration-300">Confirm
                    mail</button>
            </div>
        </div>
    </section>
