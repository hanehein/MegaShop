        ...
        <div class="min-h-screen w-1/2 px-8 md:px-16 flex justify-center items-center relative">
            ...
            <div class=" px-8 md:px-16 flex flex-col justify-center items-center">
                ...
                <form action="" class="flex flex-col gap-4">
                    <input class="p-2 my-2 rounded-xl border border-[#2C7607] shadow-md w-[400px] h-[60px] relative"
                    type="email" name="email" placeholder="Email">
                    <div class="relative">
                        <input class="p-2 my-2 rounded-xl border border-[#2C7607] shadow-md w-[400px] h-[60px]"
