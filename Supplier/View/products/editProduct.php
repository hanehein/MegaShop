                    ...
                    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="../../Controller/products/updateController.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-5">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="product_name">Product
                                Name:</label>
                            <input class="shadow border rounded w-1/2 py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline" id="product_name" name="product_name" type="text" placeholder="Enter product name" value="<?= $product["p_name"] ?>" required>
                        </div>
                                ...
                                <div>
                                    ...
                                    <select class="shadow rounded w-[300px] py-2 px-3 bg-white border border-slate-300" id="product_category" name="product_category" required>
                                        <?php foreach ($categories as $category) { ?>
                                            <option value="<?= $category["id"] ?>" <?php if ($product["p_category"] == $category["id"]) {
                                                                                        echo "selected";
                                                                                    } ?>>
                                                <?= $category["cat_name"]; ?>
                                            </option>
                                ...
                                <div>
                                    ...
                                    <select class="shadow rounded w-[300px] py-2 px-3 bg-white border border-slate-300" id="product_brand" name="product_brand" required>
                                        <?php foreach ($brands as $brand) { ?>
                                            <option value="<?= $brand["id"] ?>" <?php if ($product["p_brand"] == $brand["id"]) {
                                                                                    echo "selected";
                                                                                } ?>>
                                                <?= $brand["band_name"]; ?>
                                            </option>
                            ...
                            <div class="flex space-x-10">
                                ...
                                <div>
                                    <label class="block text-gray-700 text-sm font-bold mb-2" for="product_buy_price">Product Buy
                                        Price:</label>
                                    <input class="shadow appearance-none border rounded w-[300px] py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="product_buy_price" type="number" name="product_buy_price" placeholder="Enter product price" value="<?= $product["p_buy_price"] ?>" required>
                                </div>

                                <div>
                                    <label class="block text-gray-700 text-sm font-bold mb-2" for="product_sell_price">Product Sell
                                        Price:</label>
                                    <input class="shadow appearance-none border rounded w-[300px] py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="product_sell_price" type="number" name="product_sell_price" placeholder="Enter product price" value="<?= $product["p_sell_price"] ?>" required>
                                </div>
                            </div>
                        ...
                        <div class="mb-5">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="product_stock">Product
                                Stock</label>
                            <input class="shadow appearance-none border rounded w-[300px] py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="product_stock" type="number" name="product_stock" step="1" placeholder="Enter product price" value="<?= $product["p_stock"] ?>" required>
                        </div>

                        <div class="mb-5">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="product_discount">Product
                                Discount:</label>
                            <input class="shadow appearance-none border rounded  w-[300px] py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="product_discount" type="number" name="product_discount" step="1" placeholder="Enter product price" value="<?= $product["p_discount"] ?>" required>
                        </div>
                        ...
                        <div class="mb-5">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="product_description">Product
                                Description:</label>
                            <textarea class="shadow appearance-none border rounded w-1/2 h-[200px] py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="product_description" rows="4" name="product_description" placeholder="Enter product description" required>
