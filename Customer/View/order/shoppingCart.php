            ...
            <div class="card-container sm:col-span-2 mb-4">
                ...
                <div class="rounded-md overflow-hidden shadow-lg">
                    <div class="p-2 bg-custom-blue">
                        <p class="text-white"><a href="">Traffic Star</a></p>
                    </div>
                    <div class="flex justify-between p-4 items-center">
                        <div class="block sm:hidden">
                            <img class="max-h-[130px]" src="https://cdn.ospreyeurope.com/shop/media/catalog/product/cache/90fbb2341f4f0519805a950f9933da0d/_/0/_0035_ozonelaptopbackpack28_f22_side_coastalblue_10004643.jpg" alt="product-img">
                        </div>
                        <div class="block sm:flex sm:justify-between sm:w-full sm:items-center">
                            <div class="mb-2 flex items-center">
                                <div class="hidden sm:block">
                                    <img class="max-h-[100px]" src="https://cdn.ospreyeurope.com/shop/media/catalog/product/cache/90fbb2341f4f0519805a950f9933da0d/_/0/_0035_ozonelaptopbackpack28_f22_side_coastalblue_10004643.jpg" alt="product-img">
                                </div>
                                <div>
                                    <h2 class="text-custom-large font-bold">Tucano Backpacks TU-BP01</h2>
                            ...
                            <div class="flex space-x-2 sm:flex-col items-center mb-2">
                                <p class="text-custom-orange text-custom-extra-large">Ks 23450</p>
                                <p class="text-custom-tiny line-through">Ks 33500</p>
                                <p class="text-custom-tiny text-custom-orange">(30%)</p>
                            </div>
                            <div>
                                <div class="items-center">
