        ...
        <div class="block md:grid md:grid-cols-3 gap-4">
          <div class="p-3 shadow-lg rounded-md mb-4">
            <div class="mb-2">
              <img
                class="w-full"
                src="https://s.yimg.com/ny/api/res/1.2/iMz0GNK3Qx4N2SHGxQET0w--/YXBwaWQ9aGlnaGxhbmRlcjt3PTY0MA--/https://s.yimg.com/os/creatr-uploaded-images/2023-02/fd337a60-ac94-11ed-b12d-5acc92478cdd"
                alt="product-img"
              />
            </div>
            <div class="flex space-x-2 justify-center items-center">
              <div>
                <ion-icon
                  class="text-black text-[50px]"
                  name="chevron-back"
                ></ion-icon>
              </div>
              <div>
                <img
                  class="w-[50px] h-[50px] sm:w-[70px] sm:h-[70px]"
                  src="https://s.yimg.com/ny/api/res/1.2/iMz0GNK3Qx4N2SHGxQET0w--/YXBwaWQ9aGlnaGxhbmRlcjt3PTY0MA--/https://s.yimg.com/os/creatr-uploaded-images/2023-02/fd337a60-ac94-11ed-b12d-5acc92478cdd"
                  alt="product-img"
                />
              </div>
          ...
          <div class="col-span-2 p-3 shadow-lg rounded-md">
            ...
            <div class="border-b-2 py-2">
              ...
              <div class="flex space-x-2 items-center mb-3">
                ...
                <!-- colors -->
                <div
                  class="w-[20px] h-[20px] rounded-full bg-red-500 flex justify-center items-center"
                >
              ...
              <div class="flex space-x-2 items-center mb-3">
                ...
                <!-- sizes -->
                <div
                  class="w-[35px] h-[20px] rounded-md bg-grey flex justify-center items-center"
                >
                  <span class="text-tiny font-bold">S</span>
                </div>
                <div
                  class="w-[35px] h-[20px] rounded-md bg-white border-2 border-custom-orange flex justify-center items-center"
                >
              ...
              <div class="flex space-x-2 items-center mb-5">
                ...
                <div
                  class="w-[30px] h-[30px] rounded-md bg-grey flex justify-center items-center"
                >
                  <ion-icon class="text-white" name="remove"></ion-icon>
                </div>
                <div
                  class="w-[50px] h-[30px] rounded-md bg-grey flex justify-center items-center bg-transparent"
                >
              ...
              <div class="flex space-x-5 items-center">
                <button class="bg-orange text-white py-2 px-6 rounded-md">
                  <ion-icon class="text-extra-large" name="cart"></ion-icon> Add
                  to Cart
                </button>
                <button class="bg-blue text-white py-2 px-6 rounded-md">
        ...
        <div>
          ...
          <div class="block sm:flex sm:space-x-10 py-4">
            <div class="mb-5 sm:mb-[0px]">
              <div class="font-bold">
                <p class="mb-4">
                  <span class="text-6xl">5.0</span
                  ><span class="text-5xl text-grey"> / 5</span>
                </p>
              </div>
              <div>
                <ion-icon
            ...
            <div>
              <div class="flex space-x-5 items-center mb-3">
                <div>
                  <ion-icon
                    class="text-medium sm:text-extra-large text-orange-600"
                    name="star"
                  ></ion-icon>
                  <ion-icon
                    class="text-medium sm:text-extra-large text-orange-600"
              ...
              <div class="flex space-x-5 items-center mb-3">
                <div>
                  ...
                  ></ion-icon>
                  <ion-icon
                    class="text-medium sm:text-extra-large text-grey"
                    name="star"
                  ></ion-icon>
                </div>
          ...
          <!-- start review -->
          <div
            class="p-4 shadow-lg rounded-md border border-2 border-custom-blue mb-4"
          >
            ...
            <div>
              <ion-icon
                class="text-extra-large text-orange-600"
                name="star"
              ></ion-icon>
              <ion-icon
                class="text-extra-large text-orange-600"
          ...
          <div class="text-center">
            <button
              class="bg-orange text-white py-2 px-4 text-large rounded-md"
            >
              Load More Reviews
            </button>
          </div>
