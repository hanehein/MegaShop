    ...
    <div class="flex flex-col">
        <div class="flex flex-row bg-white mt-3 w-[350px] md:w-[500px] p-3 container mx-3 justify-between">
            ...
            <div class="flex flex-row space-x-2 md:space-x-8">
                ...
                <div class="flex flex-col text-orange-600 justify-center items-center font-semibold">
                    ...
                    <a href="../../Controller/shop/followController.php">Follow</a>
                </div>
            </div>
        </div>
        <!--submenu-->
        ...
        <section class="relative">
            <div class="block sm:grid sm:grid-cols-6 gap-4">
                <div class="hidden md:block border-r-2 border-custom-grey">
                    ...
                    <form action="" method="GET">
                        ...
                        <div class="brands-box p-4 border-custom-grey border-b-2">
                            ...
                            <ul class="text-custom-medium text-custom-grey px-2">
                                <?php foreach ($brands as $brand) { ?>
                                    <li>
                                        <input type="checkbox" name="brands[]" id="<?= $brand["id"] ?>" value="<?= $brand["id"] ?>" <?php if (isset($filterBrands) && in_array($brand["id"], $filterBrands)) {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>>
                        ...
                        <div class="price-box p-4 border-custom-grey border-b-2">
                            ...
                            <div class="flex space-x-2">
                                <input class="w-[70px] border border-custom-grey rounded-md px-2" type="text" placeholder="min" name="min_price" value="<?php if ($filterByPrice) {
                                                                                                                                                            echo $min_price;
                                                                                                                                                        } else {
                                                                                                                                                            echo "";
                                                                                                                                                        } ?>">
                                <span> - </span>
                                <input class="w-[70px] border border-custom-grey rounded-md px-2" type="text" placeholder="max" name="max_price" value="<?php if ($filterByPrice) {
                                                                                                                                                            echo $max_price;
                                                                                                                                                        } else {
                                                                                                                                                            echo "";
                                                                                                                                                        } ?>">
